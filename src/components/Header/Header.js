    ...
    <header className='page-header'>
      <div className='page-header__container container'>
        <div className='page-header__info flex-center'>
          <a href='/' className='page-header__howto flex-center'>
          ...
          <a
            href='/'
            className='page-header__contact flex-center hidden-on-mobile'
          >
        ...
        <a href='/' className='page-header__logo flex-center'>
          <span className='page-header__title'>
            <h1>Quero Bolsa</h1>
          </span>
        </a>
        <a href='/' className='page-header__user-info flex-center'>
